...
/**
 * Validation pour la création d'une fiche personnel
 */
class StorePersonnelRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'user_id' => ['nullable', 'exists:users,id', 'unique:personnel,user_id'],
            ...
            // Contact
            'email_pro' => ['required', 'email', 'max:255', 'unique:personnel,email_pro'],
